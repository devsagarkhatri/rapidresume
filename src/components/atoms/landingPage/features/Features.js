            ...
            <div className=" relative  h-[100%] w-[130%]">
                <div className="flex justify-start items-center gap-12 ">
                    <div className="flex flex-col justify-start items-center gap-5 mt-0 ">
                        <div className="flex border-2 justify-start flex-col items-center h-72 rounded-lg  w-40 p-3 bg-white ">
                            <img
                                src={fast}
                        ...
                        <div className="flex border-2 justify-start flex-col items-center h-80 rounded-lg  w-40 p-3 bg-white ">
                            <img
                                src={addVideo}
                                className="w-[70px] h-[70px] mb-2 "
                                alt="addVideo icon"
                    ...
                    <div className="flex flex-col justify-start items-center gap-5 mt-40 ">
                        <div className="flex justify-start flex-col border-2 items-center h-72 rounded-lg  w-40 p-3 bg-white ">
                            <img
                                src={targeted}
                                className="w-[70px] h-[70px] mb-2 "
                                alt="targeted icon"
                        ...
                        <div className="flex justify-start border-2 flex-col items-center h-72 rounded-lg  w-40 p-3 bg-white mt-5 ">
                            <img
                                src={efficient}
                                className="w-[70px] h-[70px] mb-2 "
                                alt="efficient icon"
