      ...
      <div className="flex justify-center items-center  gap-32 ">
        <div className="flex justify-start flex-col items-center">
          ...
          <p className="text-sm text-center   ">
            Fill out resume sections like a document with our click-to-edit
            function or upload your own json.
          </p>
        </div>
        <div className="flex justify-start flex-col items-center">
          <img
            ...
            alt="template icon"
          />
          <h3 className="text-xl font-semibold mb-5 ">Choose Template</h3>
          <p className="text-sm text-center ">
            Choose what matches your needs from plathora of templates, various
        ...
        <div className="flex justify-start flex-col items-center">
          ...
          <p className="text-sm text-center   ">
            Once ready, you can download your resume as PDF or generate a link
            for recruiters to view.
          </p>
        </div>
      </div>
    </div>
